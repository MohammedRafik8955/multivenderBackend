...
router.post(
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      console.log("Decoded user:", newUser); // Debugging line
      ...
      console.log("Error during activation:", error); // Debugging line
      return next(new ErrorHandler("Your token has expired! Please request a new activation link.", 500));
    }
  })
);
